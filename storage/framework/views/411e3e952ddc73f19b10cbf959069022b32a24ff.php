<?php $__env->startSection('title', '文章列表页'); ?>
<?php $__env->startSection('time'); ?>
    <p>当前时间：</p>
    ##parent-placeholder-714eea0f4c980736bde0065fe73f573487f08e3a##
        ...
        <div>
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="blog-post">
                    ...
                    <p class="blog-post-meta"><?php echo e($post->created_at->toFormattedDateString()); ?> <a
                                href="/user/<?php echo e($post->user->id); ?>"><?php echo e($post->user->name); ?></a></p>
